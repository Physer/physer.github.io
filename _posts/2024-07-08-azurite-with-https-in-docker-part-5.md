...
We have already done a similar thing for our Azure credentials using the `azure.env` file in [part 4](https://blog.alexschouls.nl/azure/2024/08/07/azurite-with-https-in-docker-part-4.html) of this series.
...
Continue to [part 6 here](https://blog.alexschouls.nl/azure/2024/08/07/azurite-with-https-in-docker-part-6.html).
