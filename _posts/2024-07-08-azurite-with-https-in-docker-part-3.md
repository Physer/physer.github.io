...
In [part 2](https://blog.alexschouls.nl/azure/2024/08/07/azurite-with-https-in-docker-part-2.html) of this blog series we've created a simple .NET application to interact with our Blob service from Azurite. Let's open up our application and navigate to the `Program.cs` file.
...
Continue to [part 4 here](https://blog.alexschouls.nl/azure/2024/08/07/azurite-with-https-in-docker-part-4.html).
