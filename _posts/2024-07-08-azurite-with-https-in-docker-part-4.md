...
As described in [Part 3](https://blog.alexschouls.nl/azure/2024/08/07/azurite-with-https-in-docker-part-3.html), due to the nature of the `DefaultAzureCredential` mechanism, we will need a way to authenticate to Azure. There are several ways to do so (you can view the diagram in part 3).
...
Continue to [part 5 here](https://blog.alexschouls.nl/azure/2024/08/07/azurite-with-https-in-docker-part-5.html).
